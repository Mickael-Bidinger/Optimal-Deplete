...
INSERT INTO `current_update` (`is_forcing`, `is_reseting`, `is_running`, `key_level_max`, `key_level_min`,
                              `last_leaderboard_id`, `last_modified`, `season`)
VALUES (0, 0, 0, NULL, NULL, 0, '2020-01-01 00:00:00', 0);
...
ALTER TABLE `leaderboard`
    ADD PRIMARY KEY (`id`),
    ADD UNIQUE KEY `affix` (`affix`, `chest`, `completed_timestamp`, `dungeon`, `faction`, `level`, `member_1`,
